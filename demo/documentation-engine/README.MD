...
### Deliverables
- ✅ Router Plugin (URL → screen mapping)
- ✅ Markdown Plugin (basic .md parsing)
- ✅ React UI Plugin (render markdown as HTML)
- ✅ Component Registry Plugin (resolve MDX components)
- ✅ 5 sample markdown pages
- ✅ Basic navigation
...
### Deliverables
- ✅ Sidebar Plugin (auto-generate from folder structure)
- ✅ Code Block Plugin (syntax highlighting)
- ✅ Theme Plugin (dark/light mode)
- ✅ Search Plugin (local search with MiniSearch)
...
### Deliverables
- ✅ Live Playground Plugin (run code examples)
- ✅ Versioning Plugin (multiple doc versions)
- ✅ Static Export Plugin (SSG build)
- ✅ Performance optimizations (caching, code-splitting)
- ✅ Custom MDX components (Callout, Tabs, ApiRef)
